{
  description = "Mahflow - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          mahflow = pkgs.rustPlatform.buildRustPackage {
            pname = "mahflow";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/mahip-kakan/Mahflow";
          ...
          default = self.packages.${system}.mahflow;
        }
      );
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.mahflow.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.mahflow;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.mahflow.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.mahflow;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Mahflow development environment"
              bun install
