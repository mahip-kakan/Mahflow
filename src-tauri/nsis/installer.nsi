; Custom NSIS template for Mahflow with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Mahflow for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Mahflow releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Mahflow Portable Mode"
    FileClose $0
